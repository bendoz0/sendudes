...
public class FilesDbAdapter {
    ...
    private ContentValues createFileValues(String name, String size, String dateTime, int sent){
    ...
    public long createFileRow(String name, String size, String dateTime, int sent){
        ContentValues initVals = createFileValues(name, size, dateTime, sent);
